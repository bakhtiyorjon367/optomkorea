...
const sale_dto_1 = require("../../libs/dto/sale.dto");
let SalesController = class SalesController {
    ...
    async updateStatus(id, status, amountPaid) {
        const sale = await this.salesService.updateStatus(id, status, amountPaid);
        return { data: sale };
    }
    async addPayment(id, amount, user) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SalesController.prototype, "findMine", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Query)('paymentType')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('amountPaid')),
    __metadata("design:type", Function),
