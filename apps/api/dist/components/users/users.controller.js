...
const user_dto_1 = require("../../libs/dto/user.dto");
let UsersController = class UsersController {
    ...
    async updateProfile(reqUser, dto) {
    ...
    async findManagers(reqUser, excludeSelf) {
        const omitSelf = excludeSelf === 'true' || excludeSelf === '1';
        const managers = await this.usersService.findManagers(omitSelf ? reqUser.id : undefined);
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Query)('excludeSelf')),
    __metadata("design:type", Function),
