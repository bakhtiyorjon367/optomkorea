...
export type ShipmentDocument = HydratedDocument<InferSchemaType<typeof ShipmentSchema>>;
export type ReceiptDocument = HydratedDocument<InferSchemaType<typeof ReceiptSchema>>;
export type ManagerProductDocument = HydratedDocument<InferSchemaType<typeof ManagerProductSchema>>;
export type SaleDocument = HydratedDocument<InferSchemaType<typeof SaleSchema>>;
export type SaleItemDocument = HydratedDocument<InferSchemaType<typeof SaleItemSchema>>;
export type StockTransferDocument = HydratedDocument<InferSchemaType<typeof StockTransferSchema>>;
export type FinanceTransactionDocument = HydratedDocument<InferSchemaType<typeof FinanceTransactionSchema>>;
